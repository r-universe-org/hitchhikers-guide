...
```r
# All tidyverse binaries on Ubuntu Resolute for ARM for R 4.7:
install.packages("dplyr", repos = "https://tidyverse.r-universe.dev/bin/linux/resolute-arm64/4.7")

# Only dplyr on Ubuntu Resolute for ARM for R 4.7:
install.packages("dplyr", repos = "https://tidyverse.r-universe.dev/dplyr/bin/linux/resolute-arm64/4.7")
```
